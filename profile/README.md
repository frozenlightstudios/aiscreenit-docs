...
8. Data Service.
   ...
   Для хранения размеченных снимков и аннотаций в нужном для обучения моделей формате используется self-hosted S3-хранилище MinIO
   
    Zip-архивы с сырыми данными загружаются на сервер по протоколу ftp
